...
public class CommonConstant {
    ...
    public static final String TECH_ONE_CONFIG_FILE = "/WEB-INF/CrawlTechOneConfig.xml";
    public static final String MUA_BAN_CONFIG_FILE = "/WEB-INF/CrawlMuaBanConfig.xml";
}
